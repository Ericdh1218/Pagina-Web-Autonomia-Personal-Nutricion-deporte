...
<form method="post" action="/index.php?r=registrar_post" class="max-w-md space-y-3">
...
<p class="mt-3">¿Ya tienes cuenta? <a class="text-blue-600" href="/index.php?r=login">Inicia sesión</a></p>
